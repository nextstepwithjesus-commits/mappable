...
const STOP = new Set(
  [
    ...
    'Всего', 'Всех', 'За', 'Трое', 'Тогда', 'Над', 'Так', 'Да', 'Пришли', 'Вооруженные', 'Они-то', 'Божие', 'Филистимские', 'Господню', 'Господней', 'Семейство', 'Семейства', 'Начальник', 'Князь', 'Князья', 'Царь', 'Цари', 'Жена', 'Жены', 'Дочь', 'Дочери', 'Первенец', 'Братья', 'Потом', 'Там', 'Таковы',
  ].map((w) => norm(w)),
);
